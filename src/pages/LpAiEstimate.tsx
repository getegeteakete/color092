...
const LpAiEstimate = () => {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      {/* ヒーロー */}
      <section className="relative h-[550px] flex items-center bg-hero-gradient overflow-hidden pt-20">
        {/* 背景動画 */}
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-pink/10 blur-3xl hidden md:block" />
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-accent/10 blur-3xl hidden md:block" />
        </div>
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
          ...
          >
            <div className="inline-block bg-black/40 backdrop-blur-sm rounded-2xl px-6 py-4 md:px-8 md:py-6 mb-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight drop-shadow-lg">
                <span className="text-white">AIで仮見積。</span>
                <br />
                <span className="text-gradient drop-shadow-md">来店前に費用がわかる</span>
                <br />
                <span className="text-white">新しいリフォーム相談</span>
              </h1>
            </div>
            
            <div className="inline-block bg-black/40 backdrop-blur-sm rounded-xl px-4 py-2 md:px-6 md:py-3 mb-4 md:mb-8">
              <p className="text-sm sm:text-base md:text-lg text-white/95 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
            ...
            >
              <Link to="/estimate" className="btn-gradient inline-flex items-center gap-2 text-base md:text-lg px-6 md:px-10 py-3 md:py-6 shadow-xl">
                AI仮見積を試す
